...
namespace GameFramework.UI
{
    ...
    /// 打开界面成功事件。
    /// </summary>
    public sealed class OpenUIFormSuccessEventArgs : GameFramework.Event.GameEventArgs
    {
        private static readonly int s_EventId = typeof(OpenUIFormSuccessEventArgs).GetHashCode();
