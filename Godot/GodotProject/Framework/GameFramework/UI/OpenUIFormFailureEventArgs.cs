...
namespace GameFramework.UI
{
    ...
    /// 打开界面失败事件。
    /// </summary>
    public sealed class OpenUIFormFailureEventArgs : GameFramework.Event.GameEventArgs
    {
        private static readonly int s_EventId = typeof(OpenUIFormFailureEventArgs).GetHashCode();
