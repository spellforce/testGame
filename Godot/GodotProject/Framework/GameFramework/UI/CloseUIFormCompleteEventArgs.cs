...
namespace GameFramework.UI
{
    ...
    /// 关闭界面完成事件。
    /// </summary>
    public sealed class CloseUIFormCompleteEventArgs : GameFramework.Event.GameEventArgs
    {
        private static readonly int s_EventId = typeof(CloseUIFormCompleteEventArgs).GetHashCode();
