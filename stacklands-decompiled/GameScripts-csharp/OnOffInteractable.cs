...
public class OnOffInteractable : Interactable
{
	...
	protected override void Update()
	{
		...
		if ((Object)(object)ParentCard.CardData != (Object)null)
		{
			if (ParentCard.CardData.IsOn)
			{
				((ShapeRenderer)ButtonShape).Color = ColorManager.instance.FloatingTextColorSuccess;
			}
			else
			{
				((ShapeRenderer)ButtonShape).Color = ColorManager.instance.FloatingTextColorFailed;
			}
		}
	}
